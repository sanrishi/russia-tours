      ...
      <div className="max-w-[1728px] mx-auto px-6 py-16 sm:py-20">
        ...
        <div className="max-w-3xl mb-10">
          ...
          <p className="text-white/50 text-base sm:text-lg leading-relaxed">
            India is eligible for Russia&apos;s unified e-visa — processed
            entirely online in just 4 calendar days. No invitation letter
            required.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-4 gap-4 mb-8">
          {[
            { icon: Clock, label: "Processing", value: "4 Days" },
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                body: "Enter your personal details exactly as they appear on your passport. Choose tourism as your purpose of visit.",
              },
              {
                step: "3",
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-white/50 text-xs leading-relaxed">
                ...
                — including guidance on documents, photo requirements, and the
                application form. The visa fee (~₹4,300) is not included in the
                trip price and must be paid directly on the portal.
              </p>
            </div>
          </div>
        </div>
