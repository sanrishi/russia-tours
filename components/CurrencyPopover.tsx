  ...
  return (
    <>
      ...
      >
        <RefreshCw
          size={12}
          className={`shrink-0 ${open ? "text-gold" : ""}`}
        />
        <span>
          {rates
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute top-full right-0 mt-2 w-[340px] sm:w-[380px] bg-charcoal/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl shadow-black/40 z-50"
          >
